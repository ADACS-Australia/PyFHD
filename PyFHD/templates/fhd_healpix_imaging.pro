PRO fhd_healpix_imaging, file_path_vis, status_str, export_images=export_images, cleanup=cleanup, recalculate_all=recalculate_all,$
    ...
    remove_sim_flags=remove_sim_flags,model_uv_transfer=model_uv_transfer,extra_vis_filepath=extra_vis_filepath,python_grid_path=python_grid_path,_Extra=extra

print,"START OF FHD_HEALPIX_IMAGING ",python_grid_path
...
IF Keyword_Set(snapshot_healpix_export) THEN healpix_snapshot_cube_generate_read_python,obs,status_str,psf_in,cal,params,vis_arr,$
    vis_model_arr=vis_model_arr,file_path_fhd=file_path_fhd,vis_weights=vis_weights,cmd_args=cmd_args,python_grid_path=python_grid_path,_Extra=extra
...
;           hdr=hdr,params=params,remove_sim_flags=remove_sim_flags,extra_vis_filepath=extra_vis_filepath,_Extra=extra
...
;     ;Just run this to calculate the bi_use arrays?
...
; ; ;optionally export frequency-splt Healpix cubes TODO we want to be able to feed into this
; IF Keyword_Set(snapshot_healpix_export) THEN healpix_snapshot_cube_generate_read_python,obs,status_str,psf,cal,params,vis_arr,$
