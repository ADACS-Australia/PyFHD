PRO general_healpix_imaging,cleanup=cleanup,recalculate_all=recalculate_all,export_images=export_images,version=version,$
...
WHILE fi LT n_files DO BEGIN
    ...
    fhd_healpix_imaging,vis_file_list[fi],status_str,file_path_fhd=fhd_file_list[fi],n_pol=n_pol,recalculate_all=recalculate_all,$
