...
- ``uvfits`` - The UVFITS file for the observation
- ``metafits`` - The metafits file for the observation
` ``obs_id_puma_LoBES_2s_80kHz_hbeam_woden_2.5.uvfits`` - The skymodel generated by `WODEN`_ for the observation  

Separately, there will be a beam file ``decomp_beam_pointing0.h5`` which is the beam file for the observation at pointing 0
