...
def test_grid_per_baseline(
    ...
    output_box_matrix = grid_beam_per_baseline(
        ...
        vv=h5_before["vv"],
        ww=h5_before["ww"],
        l_mode=h5_before["l_mode"],
        m_mode=h5_before["m_mode"],
        n_tracked=h5_before["n_tracked"],
        frequency_array=h5_before["frequency_array"],
        x=h5_before["x"],
        y=h5_before["y"],
        xmin_use=h5_before["xmin_use"],
        ymin_use=h5_before["ymin_use"],
        freq_i=h5_before["freq_i"],
        bt_index=h5_before["bt_index"],
        polarization=h5_before["polarization"],
        image_bot=h5_before["image_bot"],
        image_top=h5_before["image_top"],
        psf_dim3=h5_before["psf_dim3"],
        box_matrix=h5_before["box_matrix"],
        vis_n=h5_before["vis_n"],
    )
