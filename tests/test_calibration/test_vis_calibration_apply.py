...
def test_vis_calibration_apply(before_file, after_file):
    """
    Runs the test on `vis_calibration_apply`. It reads in the data in before_file
    and after_file, and then calls `vis_calibration_apply`, checking the outputs match
    """
